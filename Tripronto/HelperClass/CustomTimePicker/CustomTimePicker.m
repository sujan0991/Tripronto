...
-(void)createClockView{
    ...
    hoursButton = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.origin.x +50 , selectedTimeView.frame.size.height/2 -25, 80, 50)];
    [hoursButton setTitle:@"12" forState:UIControlStateNormal];
    [hoursButton setTitleColor:selectedTimeColor forState:UIControlStateNormal];
    [hoursButton.titleLabel setFont:[UIFont boldSystemFontOfSize:35]];
    ...
    minuteButton = [[UIButton alloc] initWithFrame:CGRectMake(seperatorLineView.frame.origin.x +seperatorLineView.frame.size.width+10 , hoursButton.frame.origin.y, 80, 50)];
    [minuteButton setTitle:@"00" forState:UIControlStateNormal];
    [minuteButton setTitleColor:textColor forState:UIControlStateNormal];
    [minuteButton.titleLabel setFont:[UIFont boldSystemFontOfSize:35]];
