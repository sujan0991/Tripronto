...
static NSString * const kMARKRangeSliderThumbImage = @"sliderPoint";
static NSString * const kMARKRangeSliderTrackImage = @"sliderBG";
static NSString * const kMARKRangeSliderTrackRangeImage = @"sliderRangeBG";
...
- (void)layoutSubviews
{
    ...
    CGFloat leftInset = (leftThumbImageSize.width - 10)/ 2;
    CGFloat rightInset = (rightThumbImageSize.width +10 ) / 2;
