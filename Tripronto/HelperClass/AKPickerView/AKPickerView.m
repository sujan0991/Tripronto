...
- (void)initialize
{
	self.font = self.font ?: [UIFont fontWithName:@"AzoSans-Regular" size:17];
	self.highlightedFont = self.highlightedFont ?: [UIFont fontWithName:@"AzoSans-Regular" size:17];
    ...
    dot.image=[UIImage imageNamed:@"pickerBG"];
    [self.collectionView.backgroundView addSubview:dot];
}
...
//    mask.frame = CGRectInset(self.collectionView.bounds, 10.0f, 10.0f);
//    mask.cornerRadius = 5.0f;
//    self.collectionView.layer.mask = mask;
