...
- (void)addParallaxWithView:(UIView*)view andHeight:(CGFloat)height withTitle:(NSString*)title {
    ...
    else
    {
        ...
        UILabel* label=[[UILabel alloc]initWithFrame:CGRectMake(0, 92, self.bounds.size.width, 50)];//Set frame of label in your viewcontroller.
        [label setBackgroundColor:[UIColor clearColor]];//Set background color of label.
        [label setText:title];//Set text in label.
        [label setFont:[UIFont fontWithName:@"AzoSans-Regular" size:17.0f]];
        
        [label setTextColor:[UIColor clearColor]];//Set text color in label.
        ...
        [parallaxView setTitleLabel:label];
...
- (void)addParallaxWithView:(UIView*)view andHeight:(CGFloat)height withAttributedTitle:(NSMutableAttributedString*)title {
    ...
    else
    {
        ...
        UILabel* label=[[UILabel alloc]initWithFrame:CGRectMake(0, 92, self.bounds.size.width, 50)];//Set frame of label in your viewcontroller.
        [label setBackgroundColor:[UIColor clearColor]];//Set background color of label.
        [label setAttributedText:title];//Set text in label.
        //[label setFont:[UIFont fontWithName:@"AzoSans-Regular" size:17.0f]];
...
- (void)setCustomView:(UIView *)customView
{
    ...
    button.frame = CGRectMake(15, 30, 55, 40);
    ...
    favButton.frame = CGRectMake( [UIScreen mainScreen].bounds.size.width-15-25, 30, 25, 25);
    [favButton setBackgroundImage:[UIImage imageNamed:@"Favorite"] forState:UIControlStateNormal];
    
    _favButton=favButton;
    
    UIView *subTitileView=[[UIView alloc] initWithFrame:CGRectMake(0,self.frame.size.height-40, [UIScreen mainScreen].bounds.size.width, 60)];
    subTitileView.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.3f];
    
    UILabel* label=[[UILabel alloc]initWithFrame:CGRectMake(15, 5, subTitileView.frame.size.width-30, 50)];//Set frame of label in your viewcontroller.
    [label setBackgroundColor:[UIColor clearColor]];
    //[label setText:_titleLabel.text];//Set text in label.
    [label setAttributedText:_titleLabel.attributedText];
    ...
    [subTitileView addSubview:label];
    
    _subTitleView=subTitileView;
...
//    NSLayoutConstraint *constraintVertical = [NSLayoutConstraint constraintWithItem:_titleLabel
...
//                                                                           constant:0.0f];
//    
//    NSLayoutConstraint *constraintHorizontal = [NSLayoutConstraint constraintWithItem:_titleLabel
...
//    NSLog(@"Back");
//   // if ([self.delegate respondsToSelector:@selector(backToPrevious)]) {
...
- (void)scrollViewDidScroll:(CGPoint)contentOffset {
    ...
    if(self.state == APParallaxTrackingActive) {
        ...
        [_subTitleView setFrame:CGRectMake(0,self.frame.size.height-60, [UIScreen mainScreen].bounds.size.width, 60)];
