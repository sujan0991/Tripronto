...
static const CGFloat thickness = 1.0;
...
-(void)setup {
    ...
    self.defaultButtonBackgroundColor = [UIColor colorWithRed:248.0/255.0 green:248.0/255.0 blue:248.0/255.0 alpha:1];
    self.defaultLabelBackgroundColor = [UIColor colorWithRed:248.0/255.0 green:248.0/255.0 blue:248.0/255.0 alpha:1];
    self.defaultTextColor = [UIColor colorWithRed:224.0/255.0 green:51.0/255.0 blue:101.0/255.0 alpha:1];
    self.disabledButtonColor = [UIColor clearColor];
    ...
    [self.decreaseButton setImage:[UIImage imageNamed:@"minusStepper"] forState:UIControlStateNormal];
    ...
    [self.increaseButton setImage:[UIImage imageNamed:@"plusStepper"] forState:UIControlStateNormal];
    ...
    self.label.font=[UIFont fontWithName:@"AzoSans-Regular" size:18.0f];
    ...
    self.minimumValue = 0;
    self.animated = NO;
    self.stepperType = ANStepperTypeDefaultNotAnimated;
...
-(void)drawRect:(CGRect)rect {
    ...
    self.tintColor = (self.tintColor)?self.tintColor:[UIColor colorWithRed:224.0/255.0 green:51.0/255.0 blue:101.0/255.0 alpha:1];
...
//                leftPath.lineWidth = halfThickness;
//                [leftPath moveToPoint:CGPointMake(self.buttonWidth, 3)];
//                [leftPath addLineToPoint:CGPointMake(self.buttonWidth, CGRectGetHeight(self.bounds)-3)];
//                [self.tintColor setStroke];
//                [leftPath stroke];
//                
//                self.leftSeparator = [CAShapeLayer layer];
//                self.leftSeparator.path = leftPath.CGPath;
//                self.leftSeparator.strokeColor = self.disabledButtonColor.CGColor;
                
                UIImageView *seperator=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"stepperSeperator"]];
                seperator.frame=CGRectMake(self.buttonWidth, 3, 2, CGRectGetHeight(self.bounds));
                
                [self addSubview:seperator];
            }
            if (!self.rightSeparator) {
//                UIBezierPath* rightPath = [UIBezierPath bezierPath];
//                [rightPath moveToPoint:CGPointMake(self.buttonWidth + self.labelWidth, 3)];
//                [rightPath addLineToPoint:CGPointMake(self.buttonWidth + self.labelWidth, CGRectGetHeight(self.bounds)-3)];
//                [self.tintColor setStroke];
//                [rightPath stroke];
//                
//                self.rightSeparator = [CAShapeLayer layer];
//                self.rightSeparator.path = rightPath.CGPath;
//                self.rightSeparator.strokeColor = self.disabledButtonColor.CGColor;
//                [self.layer addSublayer:self.rightSeparator];
             
                UIImageView *seperator=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"stepperSeperator"]];
                seperator.frame=CGRectMake(self.buttonWidth + self.labelWidth, 3, 2, CGRectGetHeight(self.bounds));
