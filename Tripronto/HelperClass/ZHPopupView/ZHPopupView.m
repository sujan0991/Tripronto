...
#define COLOR_333333 [UIColor colorWithHexString:@"#e5e5e5"]
#define COLOR_MAINRED [UIColor colorWithHexString:@"#e5e5e5"]
#define COLOR_MAINBLUE [UIColor colorWithHexString:@"#e5e5e5"]
...
- (void)configureButtonWithTitles:(NSArray *)titles confirmTitleColor:(UIColor *)confirmTitleColor otherTitleColor:(UIColor *)otherTitleColor {
    ...
    [titles enumerateObjectsUsingBlock:^(NSString *title, NSUInteger idx, BOOL *stop) {
        ...
        if (idx != titles.count - 1) {
            UIView *seperator = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(btn.frame), CGRectGetMinY(btn.frame), 1.0f, btn.frame.size.height)];
            [seperator setBackgroundColor:COLOR_E5E5E5];
            seperator.layer.zPosition=101;
            NSLog(@"seperator %@",seperator);
...
- (UIButton *)buttonWithTitle:(NSString *)title textColor:(UIColor *)textColor width:(CGFloat)width xPos:(CGFloat)xPos yPos:(CGFloat)yPos {
    ...
    [button.titleLabel setFont:[UIFont fontWithName:@"AzoSans-Regular" size:14.0f]];
    [button setBackgroundColor:[UIColor colorWithHexString:@"#E03365"]];
...
- (void)setHeadTitleFontSize:(CGFloat)headTitleFontSize {
    ...
    [self.headTitleLbl setFont:[UIFont fontWithName:@"AzoSans-Regular" size:headTitleFontSize]];
...
- (void)setContentTextFontSize:(CGFloat)contentTextFontSize {
    ...
    [self.contentTextView setFont:[UIFont fontWithName:@"AzoSans-Regular" size:contentTextFontSize]];
    [self layoutSubviews];
}
...
- (UILabel *)headTitleLbl {
    if (nil == _headTitleLbl) {
        ...
        [_headTitleLbl setFont:[UIFont fontWithName:@"AzoSans-Regular" size:20.0f]];
...
- (UITextView *)contentTextView {
    if (nil == _contentTextView) {
        ...
        [_contentTextView setTextColor:[UIColor darkGrayColor]];
        [_contentTextView setFont:[UIFont fontWithName:@"AzoSans-Regular" size:14.0f]];
