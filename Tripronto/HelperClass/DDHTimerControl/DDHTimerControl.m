...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.type = DDHTimerTypeElements;
...
- (void)layoutSubviews {
    ...
    self.fontSize = ceilf(0.75f*height);

    _titleLabel.font = [UIFont fontWithName:@"AzoSans-Regular" size:floorf(self.fontSize/2.0f)];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    NSDictionary *labelFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"AzoSans-Regular" size:self.fontSize], NSForegroundColorAttributeName:self.color, NSParagraphStyleAttributeName: labelStyle};
